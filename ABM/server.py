...
Neutrophil_slider = UserSettableParameter('slider', "Number of Neutrophils", 50, 1, 200, 1)
Macrophage_slider = UserSettableParameter('slider', "Number of Macrophages", 50, 1, 200, 1)
Fibroblast_slider = UserSettableParameter('slider', "Number of Fibroblasts", 60, 1, 400, 1)
...
IL10_slider = UserSettableParameter('slider', 'Initial IL-10', 0.5, 0, 10, 0.1)
IL6_slider = UserSettableParameter('slider', 'Initial IL6', 0.5, 0, 10, 0.1)
TNFa_slider = UserSettableParameter('slider', 'Initial TNFa', 0.5, 0, 10, 0.1)
TGFb_slider = UserSettableParameter('slider', 'Initial TGFb', 0.5, 0, 10, 0.1)
grid_width = 25
grid_height = 25
