...
Neutrophil_slider = UserSettableParameter('slider', "Number of Neutrophils", 60, 1, 100, 1)
Macrophage_slider = UserSettableParameter('slider', "Number of Macrophages", 60, 1, 100, 1)
Fibroblast_slider = UserSettableParameter('slider', "Number of Fibroblasts", 80, 1, 200, 1)
wound_size_slider = UserSettableParameter('slider', 'Wound Radius',11,1,12,1)
